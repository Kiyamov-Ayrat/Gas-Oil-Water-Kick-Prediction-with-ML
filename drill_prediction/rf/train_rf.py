...
def save_plots(model, X_test, y_test, y_pred, y_prob):
    ...
    plt.tight_layout()
    path = os.path.join(out, "rf_metrics.png")
    ...
    ax.set_title("Top-20 важных признаков — Random Forest")
    ax.set_xlabel("Важность")
    plt.tight_layout()
    path2 = os.path.join(out, "rf_feature_importance.png")
...
if __name__ == "__main__":
    ...
    y_pred, y_prob, _, _ = evaluate(model, X_test, y_test)
